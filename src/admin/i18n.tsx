...
const ko = {
  ...
  review: {
    ...
    aiCheck: 'AI 번호 확인', aiRunning: 'AI 확인 중…', aiMatch: '일치', aiMismatch: '불일치', aiUnread: '번호 판독 실패', aiSeal: '씰', aiFail: 'AI 분석 실패',
...
const en: typeof ko = {
  ...
  review: {
    ...
    aiCheck: 'AI number check', aiRunning: 'AI checking…', aiMatch: 'match', aiMismatch: 'mismatch', aiUnread: 'number unreadable', aiSeal: 'Seal', aiFail: 'AI analysis failed',
...
const zh: typeof ko = {
  ...
  review: {
    ...
    aiCheck: 'AI 号码识别', aiRunning: 'AI 识别中…', aiMatch: '一致', aiMismatch: '不一致', aiUnread: '号码无法识别', aiSeal: '铅封', aiFail: 'AI 分析失败',
...
const ru: typeof ko = {
  ...
  review: {
    ...
    aiCheck: 'AI-проверка номера', aiRunning: 'AI проверяет…', aiMatch: 'совпадает', aiMismatch: 'не совпадает', aiUnread: 'номер не распознан', aiSeal: 'Пломба', aiFail: 'Ошибка AI-анализа',
