...
const ko = {
  ...
  load: { title: '적재 계산', sub: '화물 리스트로 20/40/40HQ 적재율과 필요 컨테이너 수를 추정합니다.', addRow: '＋ 화물 추가', name: '품명', qty: '수량', dimsCm: '치수 L·W·H (cm)', weight: '중량(kg)', stack: '적재', util: '가정 적재율', results: '적재 추정', totalCbm: '총 부피', totalWeight: '총 중량', totalQty: '총 수량', needed: '필요 컨테이너', fill: '적재율', bindVol: '부피 제약', bindWt: '중량 제약', maxUnits: '1대 최대', unit: '대', recommended: '추천', notFit: '치수 초과', freight: '운임(대당·선택)', empty: '화물을 추가하면 결과가 나옵니다.', disclaimer: '부피·중량 기반 추정치입니다. 실제 적재율은 화물 모양·스택 제약에 좌우됩니다.', remove: '삭제', view3d: '3D 적재도', rotate: '회전', packed: '적재', unplaced: '미적재', cap: '표시는 상위 일부만', upload: '엑셀·CSV 업로드', uploadHint: '열: 품명·수량·L·W·H·중량·적재(선택)' },
