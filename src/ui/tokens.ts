export const C = {
  teal: '#01888F', tealStrong: '#016F75', tealHeavy: '#015056', tealBright: '#16A9B0', tealTint: '#E2F1F2',
  navy: '#0F1B26', brandNavy: '#0B2247', blue50: '#16334B', blue45: '#1B3E5C', blue55: '#22507A',
...
export const SH = {
  ...
  primary: '0 8px 20px -8px rgba(1,136,143,.5)',
} as const;
export const FONT = {
